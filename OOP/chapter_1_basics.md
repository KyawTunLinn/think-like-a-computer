...
OOP မှာ အဓိက အကျဆုံးကတော့ Class နန့် Object ပါ။  ဒီသဘောတရားနှစ်ခုက ကျွန်တော်တို့ နိန့်စဉ်ဘဝမှာ မြင်နီတွေ့နီရေ အရာတိနန့် တူပါရေ။

## Class vs Object နားလည်လွယ်မယ့် ဥပမာများ

### ၁။ မုန့်လုပ်စက် (Cookie Cutter) ဥပမာ
- **Class**: မုန့်လုပ်ဖို့ ပုံစံခွက် (Mold or Cutter)။ ဒါက စားလို့မရပါ၊ မုန့်ပုံစံထွက်ဖို့ရာ လုပ်ထားရေ ပုံစံခွက်ရာ ဖြစ်ပါရေ။
- **Object**: အေ ပုံစံခွက်က ထွက်လာရေ မုန့်တိ (Cookies)။ ဒါက တကယ်ကိုင်လို့ရရေ၊ စားလို့ရရေ အရာဝတ္ထုတိ ဖြစ်ပါရေ။
> *ပုံစံခွက်တစ်ခုတည်းကနေ မုန့်အများကြီး ထုတ်လို့ရသလို၊ Class တစ်ခုတည်းကနေ Object အများကြီး ဆောက်လို့ရပါရေ။*

### ၂။ အိမ်ဆောက်បလန် (House Blueprint) ဥပမာ
- **Class**: အိမ်ပုံစံ ဒီဇိုင်း (Blueprint)။ စက္ကူပေါ်မှာ ဆွဲထားရေ ပုံရာ ဖြစ်ပါရေ။ နီလို့မရပါ။
- **Object**: တကယ်ဆောက်လိုက်လို့ ပေါ်လာရေ အိမ် (House)။ လူနီလို့ရပါရေ။
...
### လက်တွေ့ဥပမာ - မိုဘိုင်းဖုန်း (Mobile Phone)
...
- **Object** ဆိုစွာ အေ Class ကိုသုံးပနာ တကယ်ဖန်တီးထားရေ အရာ (Real instance) ပါ။
...
1. **Design a Student**: `Student` ဟု အမည်ရသော Class တစ်ခုကို Pseudo Code ဖြင့် ရေးကြည့်ပါ။
