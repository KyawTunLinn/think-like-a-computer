...
ဒေအခန်းမှာတော့ OOP ရဲ့ လုံခြုံရေးနန့် ရှုပ်ထွေးမှု လျှော့ချရေ အပိုင်းတိကို လေ့လာလားပါဖို့။ ဒီသဘောတရားနှစ်ခုက ခွဲခြားရခက်ပေမယ့် အလုပ်လုပ်ပုံ မတူပါ (Data Hiding vs Implementation Hiding)။
...
### လက်တွေ့ဥပမာ - ATM စက်
ATM စက်ထဲမှာ ပိုက်ဆံတိ (Data) အများကြီးဟိရေ။ ဒါပေမယ့် ကျွန်တော်တို့က အဲ့ဒီပိုက်ဆံတိကို လက်နန့် တိုက်ရိုက် နှိုက်ယူလို့ မရပါ။
- **Private Data**: ပိုက်ဆံသေတ္တာ (Money Vault)။
- **Public Access**: ကဒ်ထည့်၊ PIN ရိုက်ပြီးမှ ပိုက်ဆံထုတ်ယူလို့ရရေ စနစ်။

> *Encapsulation က Data ကို ကာကွယ်ဖို့ (Protect) လုပ်ဆောင်ပါရေ။*

### Pseudo Code
`balance` (လက်ကျန်ငွေ) ကို အပြင်ကနေ တိုက်ရိုက် `0` လို့ ပြင်ပစ်လို့မရအောင် `PRIVATE` နန့် ကာကွယ်ထားပါရေ။
...
## 2. Abstraction (မလိုသည်များကို ဖျောက်ထားခြင်း)
...
### လက်တွေ့ဥပမာ - ကော်ဖီစက် (Coffee Machine)
ကော်ဖီစက်မှာ ခလုတ်တစ်ခုရာ ဟိမယ် - "Make Coffee"။
- ကျွန်တော်တို့ ခလုတ်နှိပ်လိုက်ကေ ကော်ဖီရရေ။
- စက်ထဲမှာ *ရေနွေးဆူအောင်လုပ်တာ*၊ *ကော်ဖီစေ့ကြိတ်တာ*၊ *အရည်ဖျော်တာ* တိကို ကျွန်တော်တို့ သိဖို့မလို၊ လုပ်ဖို့မလိုပါ။ စက်က အလိုအလျောက် လုပ်ပီးလားပါဖို့။
...
- **Abstraction**: ရှုပ်ထွေးရေ လုပ်ဆောင်ချက်တိကို ဖျောက်ထားပနာ ရိုးရှင်းစွာကိုရာ ပြသခြင်း (Simplicity)။

## လေ့ကျင့်ခန်း (Exercises)
1. **Secure Login**: `User` Class တစ်ခုတွင် `password` ကို အပြင်မှ တိုက်ရိုက် မပြောင်းလဲနိုင်အောင် (Encapsulation) မည်သို့ ကာကွယ်မနည်း? (`PRIVATE` keyword သုံးပြီး စဉ်းစားပါ)
2. **Car Dashboard**: ကားမောင်းသူသည် အင်ဂျင်အလုပ်လုပ်ပုံကို သိစရာမလိုဘဲ စတီယာရင်နှင့် ဘရိတ်ကိုသာ သုံးရသည်။ ဤအခြေအနေသည် OOP ၏ မည်သည့် Concept နှင့် ကိုက်ညီသနည်း? (*Abstraction* or *Inheritance*?)
